...
// Correspond à : When je soumets la requête de création d'ordre de paiement sans header authorization
When('je soumets la requête de création d\'ordre de paiement sans header authorization', async function () {
  const url = 'https://cloudrun-api-yugcnet4yq-ew.a.run.app/v1/connector/order';
  const bodyStr = JSON.stringify(this.body, null, 2);
