...
Effectue une validation complète et détaillée du body de réponse. C'est le step de vérification le plus exhaustif du projet.
...
Interroge la base de données PostgreSQL pour vérifier que l'ordre créé a bien été persisté.
...
Vérifie que la base de données est accessible. En environnement CI, cette vérification est ignorée.
