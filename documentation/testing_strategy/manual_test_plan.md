...
> **Priorité** : `P1` = critique (run daily/smoke) · `P2` = important (run régulier) · `P3` = complémentaire (run élargi)

### Domaine 1 — Parcours paiement & règles métier

| Priorité | Identifiant | Intitulé | Type |
|---|---|---|---|
| P1 | 01.01.CP | Cas nominal — 1 seul article | CP |
| P2 | 01.02.CP | Cas nominal — données minimales (sans panier) | CP |
| P1 | 02.01.CP | Paiement en statut Failed | CP |
| P1 | 03.01.CP | Deux fois le même paiement (même order_id) | CP |
| P2 | 04.01.CP | Plusieurs articles dans le panier | CP |
| P2 | 05.01.CP | Réaliser un crédit | CP |
| P2 | 06.01.CP | Annulation de débit / crédit | CP |
| P2 | 07.01.CP | Protocoles terminal_transaction_display | CP |
| P2 | 08.01.CP | force_authorization à true ou false | CP |
| P3 | 09.01.CP | Valeur monétaire très grande | CP |
| P2 | 09.02.CNP | Valeur non monétaire / tax_rate / discount incohérents | CNP |
| P3 | 10.01.CP | Unicité numéro de série du POS | CP |
| P3 | 11.01.CP | URL différente dans les notifications | CP |

### Domaine 2 — Authentification & sécurité

| Priorité | Identifiant | Intitulé | Type |
|---|---|---|---|
| P1 | 12.01.CNP | Invalid credential / autorisation manquante | CNP |
| P2 | 13.01.CNP | Bad Request | CNP |
| P3 | 14.01.CNP | Injection SQL et failles de sécurité | CNP |

### Domaine 3 — Contrat API & qualité de données

| Priorité | Identifiant | Intitulé | Type |
|---|---|---|---|
| P1 | 15.01.CNP | Devises non conformes | CNP |
| P2 | 16.01.CP | Validation format customer | CP |
| P3 | 17.01.CNP | Order avec des valeurs négatives | CNP |
| P3 | 18.01.CP | Gestion des caractères spéciaux | CP |
| P3 | 19.01.CP | Custom Data dans la description | CP |

### Domaine 4 — Intégration & résilience

| Priorité | Identifiant | Intitulé | Type |
|---|---|---|---|
| P2 | 20.01.CNP | Bad Gateway | CNP |
| P2 | 21.01.CNP | Application HiPay down | CNP |
| P3 | 22.01.CNP | Vérification du timeout | CNP |
...
- [ ] `response.order.order_id` présent, de type **string**, identique à celui envoyé
...
## 02.01.CP — Paiement en statut Failed
...
## 03.01.CP — Deux fois le même paiement (même order_id)
...
## 04.01.CP — Plusieurs articles dans le panier
...
## 06.01.CP — Annulation de débit / crédit
...
## 07.01.CP — Protocoles terminal_transaction_display
...
## 08.01.CP — force_authorization à true ou false
...
## 09.01.CP — Valeur monétaire très grande
...
## 09.02.CNP — Valeur non monétaire / incohérences dans le panier
...
## 10.01.CP — Vérification de l'unicité du numéro de série du POS
...
## 11.01.CP — URL différente dans les notifications
...
## 12.01.CNP — Invalid credential / autorisation manquante
...
## 14.01.CNP — Injection SQL et failles de sécurité
...
## 15.01.CNP — Devises non conformes
...
## 16.01.CP — Validation format customer
...
## 17.01.CNP — Order avec des valeurs négatives
...
## 18.01.CP — Gestion des caractères spéciaux
...
## 19.01.CP — Custom Data dans la description
...
## 22.01.CNP — Vérification du timeout
